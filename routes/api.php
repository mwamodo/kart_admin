...
//buyer
Route::resource('cart', 'Cart\CartController', ['parameters' => ['cart' => 'productVariation']]);

//buyer
Route::group(['prefix' => 'rating', 'namespace'  => 'Rating', 'middleware'=>['jwt.auth']], function () {
    Route::get('getrating/{productid}', 'RatingReviewController@index');
    Route::post('addrating', 'RatingReviewController@store');
});

Route::group(['namespace'  => 'QuestionAnswer', 'middleware'=>['jwt.auth'],], function () {
    Route::post('addquestion', 'QuestionAnswerController@store');
});

//buyer
Route::group(['prefix' => 'paymentmethods', 'namespace'=>'PaymentMethods',], function () {
