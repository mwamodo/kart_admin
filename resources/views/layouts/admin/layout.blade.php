...
<div id="app">
    <div class="flex justify-between items-center header-wrapper py-4 px-3  bg-white fixed w-full">
        ...
        <div class="flex items-center">
            <div>
                <img src="{{url('images/gegocart-logo.png')}}" class="w-32">
            </div>
        ...
        <div class="relative  lg:bg-transparent">
            <ul class="list-reset flex flex-row leading-loose items-center">
                <li class="mx-3">
                    <a href="{{url('/admin/changepassword')}}" class="text-xs">Change Password</a>
                </li>
                <li>
                    <a href="{{url('/logout')}}" class="text-xs flex items-center">
                        <img src="{{url('images/icons_1/logout.svg')}}" class="w-3 h-3">
                        <span class="mx-1 lg:block hidden">Logout</span>
                    </a>
                </li>
