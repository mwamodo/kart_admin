        ...
        <ul class="list-reset text-xs leading-loose  py-2 custom_shadow h-full">
            ...
            <li class="px-3 py-2 {{$class}}">
                ...
                <ul class="list-reset sidebar_submenu py-2 rounded-r">
                    ...
                    <li class="px-3 py-1"><a href="{{url('/admin/order/paymentfailed')}}" class="flex items-center"><img
                                    src="{{url('images/icons_1/payment.svg')}}" class="w-4 h-4"><span
                                    class="mx-2">{{trans('sidebar.payment')}}</span></a></li>
