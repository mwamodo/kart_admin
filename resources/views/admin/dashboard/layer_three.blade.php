                        ...
                        <div class="flex flex-col lg:flex-row px-2 py-2 lg:items-center">
                            <div class="w-full lg:w-4/5 flex items-center">
                                <div>
                                    ...
                                    <img src="{{url($product->productgallery[0]->thumbnailimage)}}" class="w-16 h-16">
                                </div>
                                <div class="px-3">
                                    ...
                                    <p class="text-sm count_txt font-medium">{{$product->formattedPrice}}<span
                                                class="line-through custom_txt mx-1">{{$product->formattedPrice}}</span>
                                    </p>
                                </div>
                            </div>
                            <div class="w-full lg:w-1/5">
                                <a href="{{url('admin/product/description/'.$product->slug)}}"
                                   class="border border_orange text-orange text-xs px-2 py-1 rounded-full view_link float-right lg:float-none">View
                                    details</a>
                            </div>
                        </div>
                    </a>
