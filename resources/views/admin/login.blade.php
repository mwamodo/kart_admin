                    ...
                    <form>
                        ...
                        <div class="py-4">
                            <div class="flex items-center justify-between">
                                <a href="{{ route('forget-password') }}" class="text-2xl lg:text-xs">Forget Password
                                    ?</a>
                            </div>
                        </div>
                        <div class="pt-3">
                            <button class="bg_orange text-white text-2xl lg:text-sm px-8 py-2 rounded-full custom_shadow login_btn focus:outline-none">
                                LOGIN
                            </button>
                        </div>
                    </form>
