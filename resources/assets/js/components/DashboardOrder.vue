        ...
        <div class="px-3 py-3">
          ...
          <div class="py-3 flex items-center justify-between">
            ...
            <div class="flex flex-col items-end">
              ...
              <p class="flex items-center custom_txt text-3xl lg:text-xs"><img v-if="orderBuyer.range=='high'"
                                                                               :src="this.url+'/images/icons_1/high.svg'"
                                                                               class="w-3 h-3 mx-1">
        ...
        <div class="px-3 py-3">
          ...
          <div class="py-3 flex items-center justify-between">
            ...
            <div class="flex flex-col items-end">
              ...
              <p class="flex items-center custom_txt text-3xl lg:text-xs"><img v-if="orderSeller.range=='high'"
                                                                               :src="this.url+'/images/icons_1/high.svg'"
                                                                               class="w-3 h-3 mx-1">
